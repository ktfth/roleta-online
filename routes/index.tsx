...
export default function Home({ data: rooms }: PageProps<Room[]>) {
  ...
  return (
    <>
      <a href="https://github.com/ktfth/roleta-online"><img decoding="async" width="149" height="149" src="https://github.blog/wp-content/uploads/2008/12/forkme_right_green_007200.png" style={{position: 'absolute', top: 0, right: 0, border: 0}} alt="Faça um fork no GitHub" loading="lazy" /></a>
      <Head>
